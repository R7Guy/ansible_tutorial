...
@/home/oracle/scripts/ONTW_Directories.sql
@/home/oracle/scripts/purge_unified_audit_trail.sql
exit
EOF6

mailx -s "DB_Clone_MPD_ONTW" -a ${LOG_FILE} ${LIST} < /home/oracle/bin/clone_ontw.txt
mailx -s "DB_Clone_MPD_ONTW" -a ${LOG_FILE} ron.vanden.bulk@cgi.com < /home/oracle/bin/clone_ontw.txt
mailx -s "DB_Clone_MPD_ONTW" -a ${LOG_FILE} nandita.bhunia@cgi.com < /home/oracle/bin/clone_ontw.txt
mailx -s "DB_Clone_MPD_ONTW" -a ${LOG_FILE} sumathi.vunnam@cgi.com < /home/oracle/bin/clone_ontw.txt
