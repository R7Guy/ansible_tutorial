...
cd /tmp && rm -rf /u02/oradata/PRE/datafile/*.dbf
cd /tmp && rm -rf /u02/oradata/PRE/controlfile/*.ctl
cd /tmp && rm -rf /u03/oradata/PRE/controlfile/*.ctl
cd /tmp && rm -rf /u02/oradata/PRE/onlinelog/*.log
cd /tmp && rm -rf /u03/oradata/PRE/onlinelog/*.log
cd /tmp && rm -rf /u02/oradata/PRE/datafile/*.tmp
...
mailx -s "DB_Clone_MPD_PRE" -a ${LOG_FILE} ${LIST} < /home/oracle/bin/clone_pre.txt
mailx -s "DB_Clone_MPD_PRE" -a ${LOG_FILE} ron.vanden.bulk@cgi.com < /home/oracle/bin/clone_pre.txt
mailx -s "DB_Clone_MPD_PRE" -a ${LOG_FILE} nandita.bhunia@cgi.com < /home/oracle/bin/clone_pre.txt
mailx -s "DB_Clone_MPD_PRE" -a ${LOG_FILE} sumathi.vunnam@cgi.com < /home/oracle/bin/clone_pre.txt

#mailx -s "Clone_$ORACLE_SID" reyaz.alibux@cgi.com < ${LOG_FILE}
