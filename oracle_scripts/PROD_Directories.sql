spool PROD_Directories.log
create or replace directory MIJNPNO_INGELEZEN as '/u03/db_dirs/inkomend/ingelezen';
create or replace directory MIJNPNO_INKOMEND as '/u03/db_dirs/inkomend';
create or replace directory MIJNPNO_PDF as '/u03/db_dirs/pdf';
create or replace directory POSTCODEMUTATIES as '/u03/db_dirs/postcodemutaties';
create or replace directory MIJNPNO_UITGAAND as '/u03/db_dirs/uitgaand';
create or replace directory UWV_SUAG_DIR as '/u03/db_dirs/external_tables/uwv_suag';
create or replace directory EXT_WAO_LOAD_DIR as '/u03/db_dirs/external_tables/wao_tape';
create or replace directory ADP_XML as '/u03/db_dirs/adp_xml';
create or replace directory BRIEF_PENSIONERING as '/u03/db_dirs/pb/3-werkmap_brieven_pensionering';
create or replace directory BRIEF_RIS as '/u03/db_dirs/pb/2-werkmap_brieven_ris';
create or replace directory UITGAANDE_WAARDEOVERDRACHT as '/u03/db_dirs/pb/uitgaande_waardeoverdracht';
create or replace directory BANKBESTANDEN_FOUT as '/u03/db_dirs/pb/bankbestanden/fout';
create or replace directory BANKBESTANDEN_VERWERKT as '/u03/db_dirs/pb/bankbestanden/verwerkt';
create or replace directory BANKBESTANDEN_STAGING as '/u03/db_dirs/pb/bankbestanden/staging';
create or replace directory WO_IN as '/u03/db_dirs/pb/waardeoverdracht_in/wo_in';
create or replace directory EENMALIGE_BRIEVEN as '/u03/db_dirs/pb/brieven/eenmalige_brieven';
create or replace directory FISCALE_TOETS as '/u03/db_dirs/pb/fiscale_toets';
create or replace directory BRIEVEN as '/u03/db_dirs/pb/brieven';
create or replace directory PDF_AO_OVERZICHT as '/u03/db_dirs/pb/ao_overzicht';
create or replace directory MUTATIELIJST_PDF as '/u03/db_dirs/pb/mutatielijst';
create or replace directory JAARWERK_DUMP as '/u03/db_dirs/pb/jaarwerk';
create or replace directory ADP_DUMP as '/u03/db_dirs/pb/adp';
create or replace directory PREMIENOTA_PDF as '/u03/db_dirs/pb/premienota';
create or replace directory INADMIN_UIT as '/u03/db_dirs/pb/inadmin_uit';
create or replace directory INADMIN_IN as '/u03/db_dirs/pb/inadmin_in';
create or replace directory FACTOR_A as '/u03/db_dirs/pb/brieven/factora';
create or replace directory GEWIJZIGDE_UITKERING as '/u03/db_dirs/pb/brieven/gewijzigde_uitkering';
create or replace directory INDIVIDUELE_OFFERTE as '/u03/db_dirs/pb/brieven/individuele_offerte';
create or replace directory INFORMATIEMIDDAG as '/u03/db_dirs/pb/brieven/informatiemiddag';
create or replace directory NEGEN_MAANDS_BRIEVEN as '/u03/db_dirs/pb/brieven/negen_maands_brieven';
create or replace directory WOKP_UIT as '/u03/db_dirs/pb/uitgaande_waardeoverdracht/wokp_uit';
create or replace directory UPO_DIR as '/u03/db_dirs/pb/upo_dir';
create or replace directory WOKP_IN as '/u03/db_dirs/pb/waardeoverdracht_in/wokp_in';
create or replace directory RUIF_FOUT as '/u03/db_dirs/risdata/da/t_en_t/pb/vo107/foutverwerkt';
create or replace directory RUIF_UITGAAND as '/u03/db_dirs/risdata/da/t_en_t/pb/vo105/aangemaakt';
create or replace directory RUIF_VERWERKT as '/u03/db_dirs/risdata/da/t_en_t/pb/vo107/verwerkt';
create or replace directory RUIF_STAGING as '/u03/db_dirs/risdata/da/t_en_t/pb/vo107/staging';
create or replace directory RUIF_INKOMEND as '/u03/db_dirs/risdata/da/t_en_t/pb/vo107/ontvangen';
create or replace directory AOP_PAIN as '/u03/db_dirs/bankbestanden';
create or replace directory BANKBESTANDEN_INKOMEND as '/u03/db_dirs/nav_exchange/ris/kwo';
create or replace directory BANKBESTANDEN_UITGAAND as '/u03/db_dirs/nav_exchange/ris/kwo';
create or replace directory NAVISION_PBDIR as '/u03/db_dirs/nav_exchange/ris';
create or replace directory NAVISION_DIR as '/u03/db_dirs/nav_exchange/ris';
create or replace directory PENSIOEN123 as '/u03/db_dirs/pensioen123';
