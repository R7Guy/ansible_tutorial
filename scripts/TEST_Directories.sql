spool TEST_Directories.log
create or replace directory MIJNPNO_INGELEZEN as '/u03/db_dirs/ota/test/inkomend/ingelezen';
create or replace directory MIJNPNO_INKOMEND as '/u03/db_dirs/ota/test/inkomend';
create or replace directory MIJNPNO_PDF as '/u03/db_dirs/ota/test/pdf';
create or replace directory POSTCODEMUTATIES as '/u03/db_dirs/ota/test/postcodemutaties';
create or replace directory MIJNPNO_UITGAAND as '/u03/db_dirs/ota/test/uitgaand';
create or replace directory UWV_SUAG_DIR as '/u03/db_dirs/ota/test/external_tables/uwv_suag';
create or replace directory EXT_WAO_LOAD_DIR as '/u03/db_dirs/ota/test/external_tables/wao_tape';
create or replace directory ADP_XML as '/u03/db_dirs/ota/test/adp_xml';
create or replace directory BRIEF_PENSIONERING as '/u03/db_dirs/ota/test/pb/3-werkmap_brieven_pensionering';
create or replace directory BRIEF_RIS as '/u03/db_dirs/ota/test/pb/2-werkmap_brieven_ris';
create or replace directory UITGAANDE_WAARDEOVERDRACHT as '/u03/db_dirs/ota/test/pb/uitgaande_waardeoverdracht';
create or replace directory BANKBESTANDEN_FOUT as '/u03/db_dirs/ota/test/pb/bankbestanden/fout';
create or replace directory BANKBESTANDEN_VERWERKT as '/u03/db_dirs/ota/test/pb/bankbestanden/verwerkt';
create or replace directory BANKBESTANDEN_STAGING as '/u03/db_dirs/ota/test/pb/bankbestanden/staging';
create or replace directory WO_IN as '/u03/db_dirs/ota/test/pb/waardeoverdracht_in/wo_in';
create or replace directory EENMALIGE_BRIEVEN as '/u03/db_dirs/ota/test/pb/brieven/eenmalige_brieven';
create or replace directory FISCALE_TOETS as '/u03/db_dirs/ota/test/pb/fiscale_toets';
create or replace directory BRIEVEN as '/u03/db_dirs/ota/test/pb/brieven';
create or replace directory PDF_AO_OVERZICHT as '/u03/db_dirs/ota/test/pb/ao_overzicht';
create or replace directory MUTATIELIJST_PDF as '/u03/db_dirs/ota/test/pb/mutatielijst';
create or replace directory JAARWERK_DUMP as '/u03/db_dirs/ota/test/pb/jaarwerk';
create or replace directory ADP_DUMP as '/u03/db_dirs/ota/test/pb/adp';
create or replace directory PREMIENOTA_PDF as '/u03/db_dirs/ota/test/pb/premienota';
create or replace directory INADMIN_UIT as '/u03/db_dirs/ota/test/pb/inadmin_uit';
create or replace directory INADMIN_IN as '/u03/db_dirs/ota/test/pb/inadmin_in';
create or replace directory FACTOR_A as '/u03/db_dirs/ota/test/pb/brieven/factora';
create or replace directory GEWIJZIGDE_UITKERING as '/u03/db_dirs/ota/test/pb/brieven/gewijzigde_uitkering';
create or replace directory INDIVIDUELE_OFFERTE as '/u03/db_dirs/ota/test/pb/brieven/individuele_offerte';
create or replace directory INFORMATIEMIDDAG as '/u03/db_dirs/ota/test/pb/brieven/informatiemiddag';
create or replace directory NEGEN_MAANDS_BRIEVEN as '/u03/db_dirs/ota/test/pb/brieven/negen_maands_brieven';
create or replace directory WOKP_UIT as '/u03/db_dirs/ota/test/pb/uitgaande_waardeoverdracht/wokp_uit';
create or replace directory UPO_DIR as '/u03/db_dirs/ota/test/pb/upo_dir';
create or replace directory WOKP_IN as '/u03/db_dirs/ota/test/pb/waardeoverdracht_in/wokp_in';
create or replace directory RUIF_FOUT as '/u03/db_dirs/ota/test/risdata/da/t_en_t/pb/vo107/foutverwerkt';
create or replace directory RUIF_UITGAAND as '/u03/db_dirs/ota/test/risdata/da/t_en_t/pb/vo105/aangemaakt';
create or replace directory RUIF_VERWERKT as '/u03/db_dirs/ota/test/risdata/da/t_en_t/pb/vo107/verwerkt';
create or replace directory RUIF_STAGING as '/u03/db_dirs/ota/test/risdata/da/t_en_t/pb/vo107/staging';
create or replace directory RUIF_INKOMEND as '/u03/db_dirs/ota/test/risdata/da/t_en_t/pb/vo107/ontvangen';
create or replace directory AOP_PAIN as '/u03/db_dirs/ota/test/bankbestanden';
create or replace directory BANKBESTANDEN_INKOMEND as '/u03/db_dirs/ota/test/nav_exchange/ris/kwo';
create or replace directory BANKBESTANDEN_UITGAAND as '/u03/db_dirs/ota/test/nav_exchange/ris/kwo';
create or replace directory NAVISION_PBDIR as '/u03/db_dirs/ota/test/nav_exchange/ris';
create or replace directory NAVISION_DIR as '/u03/db_dirs/ota/test/nav_exchange/ris';
create or replace directory PENSIOEN123 as '/u03/db_dirs/ota/test/pensioen123';
create or replace directory BRIEVEN_EMAIL as '/u03/db_dirs/ota/test/pb/brieven_email';
create or replace directory BRIEF_PENSIONERING_EMAIL as '/u03/db_dirs/ota/test/pb/brieven_pensionering_email';
create or replace directory BRIEF_RIS_EMAIL as '/u03/db_dirs/ota/test/pb/brief_ris_email';
